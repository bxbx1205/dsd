...
REM
REM Generated by Vivado on Tue Jan 28 10:40:53 +0530 2025
...
call xsim  TB_HA_behav -key {Behavioral:sim_1:Functional:TB_HA} -tclbatch TB_HA.tcl -log simulate.log
